...
class BarChartSample extends StatefulWidget {
  ...
  final Color leftBarColor = const Color.fromARGB(255, 71, 253, 195);
  final Color rightBarColor = const Color.fromARGB(255, 255, 242, 66);
  final Color avgColor = Colors.orange;
  @override
  State<StatefulWidget> createState() => BarChartSample2State();
}

class BarChartSample2State extends State<BarChartSample> {
